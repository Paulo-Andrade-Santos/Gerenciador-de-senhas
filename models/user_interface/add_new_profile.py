...
class NewProfile:
    """Classe responsável por exibir a janela de cadastro de um novo usuário no banco de dados."""
    def __init__(self):
    ...
    def __make_entrys(self) -> None:
        """Método responsável por desenhar os campos de entrada de dados."""
    ...
    def __make_check_buttons(self) -> None:
    ...
    def __welcome_screen(self) -> None:
        ...
        from models.user_interface.welcome_screen import WelcomeScreen  # Esta importação foi realizada dentro do método para evitar o erro de 'importação circular'.
        WelcomeScreen().run()

    def __insert_record(self, event=None) -> None:
